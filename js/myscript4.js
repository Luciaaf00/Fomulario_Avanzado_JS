...
function obtenerSwift(cuentaBancaria) {
/*
...
bicMap["9000"] = "ESPBESMMXXX";
    ...
    return bicMap[cuentaBancaria];
}
$("#cuenta_bancaria").change(function(){
    console.log("si");
if(validacionCuentaBancaria("#cuenta_bancaria")){
    console.log("so");
    var resultado=obtenerSwift("#cuenta_bancaria");
    console.log(resultado);
    //document.span.innerHTML = obtenerSwift("#cuenta_bancaria");
}
});
